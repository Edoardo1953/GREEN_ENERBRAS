...
with open(r'C:\Users\Edoardo\.gemini\antigravity\scratch\GREEN_ENERBRAS\admin\clean_records.json', encoding='utf-8') as f:
    records = json.load(f)

records_js = json.dumps(records, ensure_ascii=False, indent=2)
...
with open(r'C:\Users\Edoardo\.gemini\antigravity\scratch\GREEN_ENERBRAS\admin\contabilita_app.js', 'w', encoding='utf-8') as f:
    f.write(template)

print('Generated admin/contabilita_app.js successfully!')
